...
<div class="right_col" role="main">
	<div class ="x_panel">
      ...
      <?php endif; ?>
			<form id="demo-form5" data-parsley-validate class="form-horizontal form-label-left" method ="post" action="<?php echo base_url();?>index.php/appointment/add">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class ="btn btn-primary" href="<?php echo base_url();?>index.php/apointment/index">Cancel</a>
